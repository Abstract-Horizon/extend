...
public class TomcatWarModuleLoader extends ServiceModuleLoader {
    ...
    /**
     * Creates new module {@link TomcatWebApplicationContext} module
     * @param url url for the module
     * @return newly created module
     */
    protected AbstractApplicationContextModule createModule(URL url) {
        return new TomcatWebApplicationContext(ModuleId.createModuleIdFromFileName(url.getPath()));
    }
    ...
    protected void preDefinitionProcessing(AbstractApplicationContextModule service) {
        TomcatWebApplicationContext tomcatContext = (TomcatWebApplicationContext)service;
